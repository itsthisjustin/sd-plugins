...
Copy this folder to the SD card at `/.crosspoint/plugins/bookfusion/`.
...
3. Once signed in, your library appears. Move with the side buttons, use the
   next-page button for more, and press Confirm to download a book.
